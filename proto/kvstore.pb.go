...
type PutRequest struct {
	...
	Value         []byte                 `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"` // Using bytes so we can store any type of data
...
type GetResponse struct {
	...
	Found         bool                   `protobuf:"varint,2,opt,name=found,proto3" json:"found,omitempty"` // Helps differentiate between a nil value and a missing key
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_kvstore_proto_rawDesc = "" +
	...
	"\x06Delete\x12\x16.kvstore.DeleteRequest\x1a\x17.kvstore.DeleteResponseB*Z(github.com/ski-akash/dist-kv-store/protob\x06proto3"
...
var file_proto_kvstore_proto_depIdxs = []int32{
	...
	1, // 3: kvstore.KVStore.Put:output_type -> kvstore.PutResponse
